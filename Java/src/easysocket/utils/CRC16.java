...
public class CRC16 {
	...
	static Logger logger = LoggerFactory.getLogger(CRC16.class);

	public static void main(String[] args) {
		byte[] data = new byte[] { (byte) 1 };
		short crc = calculate(data);
	 ...
	 * @return CRC值
	 */
	public static short calculate(byte[] data) { // 初始化
		int crcHi = 0xFF; // 高字节
		int crcLo = 0xFF; // 低字节
		if (data != null) {
			for (byte b : data) {
	 ...
	 * CRC16查找表低字节
	 */
	private static final int[] CRC16TABLE_LO = { 0x00, 0xC0, 0xC1, 0x01, 0xC3,
